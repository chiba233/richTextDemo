...
const translations: Record<string, TranslationCopy> = {
  zh: {
    heroKicker: "Vue 3 +",
    heroTitle: "yumeDSL 在线 Demo",
    heroCopy:
      "一套面向富文本的可扩展标记语言。声明你需要的标签，编辑器随输入实时解析，并按改动增量重渲染。",
...
%`,
  ...
  en: {
    heroKicker: "Vue 3 +",
    heroTitle: "yumeDSL online demo",
    heroCopy:
      "An extensible markup language for rich text. Declare the tags you need; the editor parses as you type and re-renders incrementally — only what changed gets recomputed.",
    registryEyebrow: "Registry",
...
%`,
  ...
  ja: {
    heroKicker: "Vue 3 +",
    heroTitle: "yumeDSL オンラインデモ",
    heroCopy:
      "リッチテキストのための拡張可能なマークアップ言語。必要なタグを宣言すれば、入力に応じてリアルタイムに解析し、変更箇所だけを増分描画します。",
    registryEyebrow: "Registry",
